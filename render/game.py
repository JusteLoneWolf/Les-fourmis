...
class Lunch:
    def __init__(self):
        ...
        self.TextBack = pygame.font.SysFont('mvboli', 25).render('Quit', True, (0, 0, 0), )
    ...
    def lunch(self, screen):
        ...
        while True:
            ...
            screen.blit(self.game.nouriture.image,self.game.nouriture.Imagerect)
            ...
            if num == 1 and game.player.rect.x + game.player.rect.width < screen.get_width():  # si la touche
